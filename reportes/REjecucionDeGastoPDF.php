<?php
//(Franklin Espinoza A.-09/10/2020) Ejecución de Gastos Sigep
require_once dirname(__FILE__).'/../../pxp/lib/lib_reporte/ReportePDF.php';
require_once(dirname(__FILE__) . '/../../lib/tcpdf/tcpdf_barcodes_2d.php');
class REjecucionDeGastoPDF extends  ReportePDF{
    var $datos ;
    var $ancho_hoja;
    ...
    function Header() {
        ...
        $tbl = '<table border="0" style="font-size: 7pt;"> 
                    <tr><td width="33%">IMAGEN</td> <td width="33%"><b>REGISTRO DE EJECUCIÓN DE GASTOS</b></td> <td width="33%">CUADRADO</td> </tr>
                </table>';
        $this->writeHTML($tbl);

        /*if ($this->bandera_header == 1) {
            $this->Ln(6);
            $tbl = '<table border="0" style="font-size: 7pt;"> 
            ...
            $tbl .= '<tr><td colspan="10" align="center"><b>CLASE DE GASTO: (' . $this->codigo_cg . ') ' . $this->nombre_cg . '</b></td></tr>
                             <tr>
                                <td width="7%" align="center"><b>CENTRO DE COSTO</b></td>
                                <td width="5%" align="center"><br><b>PROG.</b></td>
                                <td width="5%" align="center"><br><b>PROY.</b></td>
    ...
    function setDatos($datos) {
        ...
        $this->codigo_moneda = $this->datos[0]['codigo_moneda'];
