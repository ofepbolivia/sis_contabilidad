...
<tbody>
	<tr>
		...
		<td style="width: 23%; color: #444444; text-align: left;">&nbsp;&nbsp;<b>Gestion:</b> <?php  echo date('Y'); ?> </td>
	</tr>
    <tr>
	...
	<tr>
		<td style="width: 23%; color: #444444; text-align: left;">&nbsp;&nbsp;<b>N°:</b> <?php  echo $this->cabecera[0]['nro_cbte']; ?> </td>
	</tr>
	<tr>
