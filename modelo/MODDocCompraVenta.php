...
class MODDocCompraVenta extends MODbase
{
    ...
    function listarDocCompraVenta()
    {
        ...
        $this->captura('tipo_compra_venta', 'varchar');
        $this->captura('con_derecho_cf', 'varchar');        
        $this->captura('estado_consolidacion', 'varchar');        
    ...
    function agregarCbteDoc()
    {
        ...
        $this->setParametro('id_int_comprobante', 'id_int_comprobante', 'int8');
        $this->setParametro('id_plan_pago', 'id_plan_pago', 'integer');
        $this->setParametro('id_int_transaccion', 'id_int_transaccion', 'int8');
    ...
    function addAllFields(){
        ...
        $this->setParametro('tipo_compra_venta','tipo_compra_venta', 'varchar');        
        $this->setParametro('con_derecho_cf','con_derecho_cf', 'varchar');        
        $this->setParametro('estado_consolidacion','estado_consolidacion', 'varchar');                        
    }
    function setValuesIni(){
        $this->addUpdParametro('importe_ice', 0, 'numeric');
        $this->addUpdParametro('importe_iva', 0, 'numeric');
        $this->addUpdParametro('importe_descuento', 0, 'numeric');
        $this->addUpdParametro('importe_doc', 0, 'numeric');
        $this->addUpdParametro('importe_it', 0, 'numeric');
        $this->addUpdParametro('importe_descuento_ley', 0, 'numeric');
        $this->addUpdParametro('importe_pago_liquido', 0, 'numeric');
        $this->addUpdParametro('id_moneda', 1, 'int4');
        $this->addUpdParametro('importe_pendiente', 0, 'numeric');
        $this->addUpdParametro('importe_anticipo', 0, 'numeric');
        $this->addUpdParametro('importe_retgar', 0, 'numeric');
        $this->addUpdParametro('importe_neto', 0, 'numeric');
        $this->addUpdParametro('importe_iehd',0, 'numeric');
        $this->addUpdParametro('importe_ipj', 0,'numeric');
        $this->addUpdParametro('importe_tasas', 0, 'numeric');
        $this->addUpdParametro('importe_gift_card',0, 'numeric');        
    }


/************************************************ */
/************************************************ */
    // whf se quita las opciones EXT y de BOA, se deja funciones por mantto
