...
class MODReporteExt extends MODbase
{
    function reporteDetalleGastos()
    {
        ...
        $this->captura('nro_registro', 'varchar');
        $this->captura('nro_op_registro', 'varchar');
        $this->captura('fecha', 'date');
        $this->captura('tipo_cambio_2', 'numeric');
        $this->captura('vacio_factura', 'varchar');
        ...
        $this->captura('monto_bs', 'numeric');
        $this->captura('monto_argentinos', 'numeric');
