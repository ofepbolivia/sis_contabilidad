                     ...
                     t_doc_devengado AS
                         (
                             ...
                             where pg_devengado.estado = 'devengado'
                               ...
                               AND (plantilla.tipo_informe = 'lcv' OR plantilla.id_plantilla = 28 or plantilla.tipo_informe = 'otros')
                             --AND nro_cuota = 3
                         ),
                     t_libro_pagado AS
                         (
...
ALTER FUNCTION conta.ft_banca_compra_venta_ime (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;