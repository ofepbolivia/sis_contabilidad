CREATE OR REPLACE FUNCTION conta.f_gen_transaccion_pvr (
...
BEGIN
    ...
    v_nombre_funcion:='conta.f_gen_transaccion_pvr';

    --  FOR leer la plantillas de transaccion primarias
    --raise 'p_super: %, p_tabla_padre: %, p_plantilla_comprobante: %, p_id_tabla_padre_valor: %, p_id_int_comprobante: %',p_super, p_tabla_padre, p_plantilla_comprobante,p_id_tabla_padre_valor, p_id_int_comprobante;
    --raise 'id_planilla %, %', (p_plantilla_comprobante->'id_plantilla_comprobante'), p_primario;
 	IF p_primario = 'si' THEN --RAISE 'A';
...
--RAISE notice 'v_plantilla_det: %',v_plantilla_det;
                 ...
                 -- llamada recursiva
                   ...
                   resp_det =  conta.f_gen_transaccion_pvr( p_super,
                                                        p_tabla_padre,
                                                        p_plantilla_comprobante,
                                                        p_id_tabla_padre_valor,
                                                        p_id_int_comprobante,
   ...
   ELSE  --RAISE 'B';
           ...
           FOR v_plantilla_det_sec in (
                ...
                RAISE notice 'v_plantilla_det_sec: %',v_plantilla_det_sec;
...
ALTER FUNCTION conta.f_gen_transaccion_pvr (p_super public.hstore, p_tabla_padre public.hstore, p_plantilla_comprobante public.hstore, p_id_tabla_padre_valor integer, p_id_int_comprobante integer, p_id_usuario integer, p_primario varchar, p_id_detalle_plantilla_fk integer)
  OWNER TO postgres;