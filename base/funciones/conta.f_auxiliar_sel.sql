	...
	***********************************/
		...
		begin
			...
			v_consulta:='select count(auxcta.id_auxiliar)
						...
						left join segu.tusuario usu2 on usu2.id_usuario = auxcta.id_usuario_mod '||
                        v_inner || '
					    where auxcta.estado_reg = ''activo'' and ';
        ...
        /*********************************
        #TRANSACCION:  'CONTA_AUXCTACO_SEL'
        #DESCRIPCION:	Consulta de datos
        #AUTOR:		Maylee Perez Pastor
        #FECHA:		24-03-2021 20:44:52
        ***********************************/

        elsif(p_transaccion='CONTA_AUXCTACO_SEL')then
            ...
            /*********************************
            #TRANSACCION:  'CONTA_AUXCTACO_CONT'
            #DESCRIPCION:	Conteo de registros
            #AUTOR:		Maylee Perez Pastor
        	#FECHA:		24-03-2021 20:44:52
            ***********************************/

            elsif(p_transaccion='CONTA_AUXCTACO_CONT')then
                ...
                begin
                    ...
                    v_consulta:='select count(auxcta.id_auxiliar)
                                ...
                                left join segu.tusuario usu2 on usu2.id_usuario = auxcta.id_usuario_mod '||
                                v_inner || '
                                where auxcta.estado_reg = ''activo'' and auxcta.corriente =  ''si'' and ';
