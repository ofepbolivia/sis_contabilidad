   ...
   where ic.id_int_comprobante = p_id_int_comprobante;
     ...
     FOR v_registros in (select *
          ...
          IF upper(trim(v_registros_cbte.codigo)) in ('PAGO','PAGOCON') and v_registros_cbte.codigo_sistema  != 'PLANI'  THEN
              ...
              IF v_id_cuenta_bancaria is not null and v_registros_cbte.id_depto not in (50)  THEN
...
ALTER FUNCTION conta.f_int_trans_procesar (p_id_int_comprobante integer)
  OWNER TO postgres;