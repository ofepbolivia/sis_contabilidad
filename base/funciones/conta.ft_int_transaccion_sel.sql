...
/*********************************
 	#TRANSACCION:  'CONTA_JSON_DAT_SEL'
 	#DESCRIPCION:	Datos en Json para el reporte del libro mayor
 	#AUTOR:		Ismael Valdivia
 	#FECHA:		4-11-2020 11:11:00
	***********************************/

	elsif(p_transaccion='CONTA_JSON_DAT_SEL')then
