            ...
            },
            {
                config:{
                    ...
                    renderer:function (value, rec, i ){
                        var llave = '';
                        switch(value){
                            case 'cerrado': llave = '<b style="text-align: center; color: red ;">Cerrado</b>'
                            break;
                            case 'abierto': llave = '<b style="text-align: center; color: green ;">Abierto</b>'
                            break;
                            case 'cerrado_parcial': llave = '<b style="text-align: center; color: brown;">Cierre Parcial</b>'
                            break;
                        }
