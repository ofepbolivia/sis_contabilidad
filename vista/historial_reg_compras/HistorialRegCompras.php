...
Phx.vista.HistorialRegCompras=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
...

        {
            ...
            type:'TextField',
            filters:{pfiltro:'hrc.nro_factura',type:'string'},
            id_grupo:1,
            grid:true,
            form:true
        },

        {
            ...
            type:'TextField',
            filters:{pfiltro:'hrc.nro_autorizacion',type:'string'},
            id_grupo:1,
            grid:true,
            form:true
        },

        {
            ...
            type:'TextField',
            filters:{pfiltro:'hrc.razon_social',type:'string'},
            id_grupo:1,
            grid:true,
            form:true
        },

        {
            ...
            type:'TextField',
            filters:{pfiltro:'hrc.codigo_control',type:'string'},
            id_grupo:1,
            grid:true,
            form:true
        },
...

        {
            ...
            type:'TextField',
            filters:{pfiltro:'hrc.nro_tramite',type:'string'},
            id_grupo:1,
            grid:true,
            form:true
        },
    ...
    onReloadPage:function(param){
        this.maestro = param;
        console.log('maestrex',this.maestro.id_doc_compra_venta);
