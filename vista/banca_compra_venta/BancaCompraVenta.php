    ...
    Phx.vista.BancaCompraVenta = Ext.extend(Phx.gridInterfaz, {
        ...
        */
                ...
                /*this.addButton('btnChequeoDocumentosWf', //fRnk: deshabilitado c) HR00528-2024
            {
                ...
                //this.addButton('exportar',{argument: {imprimir: 'exportar'},text:'<i class="fa fa-file-text-o fa-2x"></i> Generar TXT - SIN',/*iconCls:'' ,*/disabled:true,handler:this.generar_txt}); //fRnk: se ocultó a solicitud HR00586-2025

                this.addButton('btnExportar', //fRnk: nuevo botón para exportación, HR00586-2025
                    {
                        iconCls: 'bexcel',
                        grupo: [0, 4],
                        tooltip: '<b>Exportar XLS</b><br>Exportar con formato SIN.',
                        text: 'Exportar XLS',
                        handler: this.onButtonExportarExcelSIN,
                        argument: {
                            'news': true,
                            def: 'reset'
                        },
                ...
                this.addButton('Importar', {
                    argument: {imprimir: 'Importar'},
                    text: '<i class="fa fa-file-text-o fa-2x"></i> Importar SIN',//fRnk: varias modificaciones en bancarización para la importación y exportación, HR00586
                    disabled: true,
                    handler: this.importar_txt
                });


                this.addButton('Acumulado', {
                    argument: {imprimir: 'Acumulado'},
                    text: '<i class="fa fa-file-text-o fa-2x"></i> Acumulado',/*iconCls:'' ,*/
                    disabled: true,
                    handler: this.acumulado
                });


                this.addButton('BorrarTodo', {
                    argument: {imprimir: 'BorrarTodo'},
                    text: '<i class="fa fa-file-text-o fa-2x"></i> BorrarTodo',/*iconCls:'' ,*/
                    disabled: true,
                    handler: this.BorrarTodo
                });


                this.addButton('Clonar', {
                    argument: {imprimir: 'Clonar'},
                    text: '<i class="fa fa-file-text-o fa-2x"></i> Clonar',/*iconCls:'' ,*/
                    disabled: true,
                    handler: this.Clonar
                });
                ...
                //this.addButton('exportarGestionCompleta',{argument: {imprimir: 'exportarGestionCompleta'},text:'<i class="fa fa-file-text-o fa-2x"></i> Generar Gestion TXT - SIN',/*iconCls:'' ,*/disabled:true,handler:this.exportarGestionCompleta}); //fRnk: se ocultó a solicitud HR00586-2025


                this.addButton('consultarPosiblesBancarizaciones', {
                    argument: {imprimir: 'consultarPosiblesBancarizaciones'},
                    text: '<i class="fa fa-file-text-o fa-2x"></i> Posibles Bancarizaciones',/*iconCls:'' ,*/
                    disabled: true,
                    handler: this.consultarPosiblesBancarizaciones
                });
            ...
            validarFiltros: function () {
                if (this.cmbDepto.getValue() && this.cmbGestion.validate() && this.cmbPeriodo.validate()) {
                    ...
                    if (this.cmbPeriodo.getValue() == 0) {
                        ...
                        this.getBoton('btnExportar').enable();
                        this.getBoton('new').enable();
			...
			Ext.Ajax.request({
                ...
                this.Cmp.id_cuenta_bancaria.on('select', function (combo, record, index) {
                    ...
                    if (this.Cmp.id_cuenta_bancaria.getValue() == 61) {
                        ...
                        this.Cmp.tipo_documento_pago.store.load({
                ...
                this.Cmp.id_contrato.on('select', function (combo, record, index) {
                    ...
                    if (record.data.tipo_plazo == 'tiempo_indefinido') {
                        ...
                        Ext.Ajax.request({
                            url: '../../sis_contabilidad/control/BancaCompraVenta/listarBancaCompraVenta',
                            params: {
                                'id_contrato': record.data.id_contrato,
                                'sort': 'id_banca_compra_venta',
                                'dir': 'DESC',
                                'start': 0,
                                'limit': 1
                            },
            ...
            Atributos: [
...

                {
                    config: {
                        name: 'tramite_cuota',
                        fieldLabel: 'N°', //fRnk: HR00586-2025, original: "Trámite cuota"
                        allowBlank: true,
                        anchor: '80%',
                        gwidth: 100,
                        maxLength: 8,
                    ...
                    type: 'NumberField',//type:'TextField',
                    filters: {pfiltro: 'banca.tramite_cuota', type: 'numeric'}, //string
                    id_grupo: 0,
                    grid: true,
                    form: true
                },
                ...
                },
                {
                    config: {
                        ...
                        fieldLabel: 'Forma de pago', //Modalidad Transacción
                        allowBlank: false,
                        ...
                        store: new Ext.data.JsonStore({
                            ...
                            remoteSort: true,
                            baseParams: {par_filtro: 'confba.descripcion#confba.tipo', tipo: 'Forma de pago'} //fRnk: original: tipo:'Modalidad de transacción'
                        }),
                        valueField: 'digito',
                ...
                },
                {
                    ...
                    type: 'TextField',
                    filters: {pfiltro: 'banca.complemento', type: 'string'},
                    id_grupo: 0,
                    grid: true,
                    form: true
                },

                {
                    config: {
                        name: 'razon',
                        fieldLabel: 'Nombre o Razón Social del Proveedor',
                        allowBlank: true,
                        anchor: '80%',
                        gwidth: 100,
                        maxLength: 240
                ...
                },
                {
                    config: {
                        ...
                        fieldLabel: 'Fecha de la factura o documento de respaldo',
                        allowBlank: false,
                        anchor: '80%',
                        gwidth: 100,
                        format: 'd/m/Y',
                ...
                },
                {
                    config: {
                        name: 'autorizacion',
                        fieldLabel: 'Código de autorización',
                        allowBlank: false,
                        anchor: '80%',
                        gwidth: 100,
                        maxLength: 70
                ...
                },
                {
                    ...
                    type: 'NumberField',
                    filters: {pfiltro: 'banca.num_documento', type: 'numeric'},
                    id_grupo: 0,
                    grid: true,
                    form: true
                },
                {
                    config: {
                        ...
                        fieldLabel: 'Tipo de documento de respaldo',
                        allowBlank: true,
                        anchor: '80%',
                        gwidth: 100,
                        maxLength: 10
                ...
                {
                    config: {
                        name: 'nro_documento_respaldo',
                        fieldLabel: 'Número de documento de respaldo',
                        allowBlank: true,
                        anchor: '80%',
                        gwidth: 100,
                        maxLength: 30
...

                {
                    config: {
                        name: 'num_contrato',
                        fieldLabel: 'N° de contrato o acuerdo',
                        allowBlank: true,
                        anchor: '80%',
                        gwidth: 100,
                        maxLength: 50
                ...
                },
                {
                    config: {
                        name: 'nit_entidad',
                        fieldLabel: 'NIT Entidad Financiera de débito',
                        allowBlank: true,
                        anchor: '90%',
                        gwidth: 100,
                        maxLength: 15
...

                {
                    config: {
                        ...
                        fieldLabel: 'Número de transacción o número de operación del pago abonado',
                        allowBlank: false,
                        anchor: '90%',
                        gwidth: 100,
                        maxLength: 100
...

                {
                    config: {
                        ...
                        store: new Ext.data.JsonStore({
                            ...
                            remoteSort: true,
                            baseParams: {
                                par_filtro: 'confba.descripcion#confba.tipo#confba.digito',
                                tipo: 'Tipo de documento de pago'
                            }
                        }),
                        valueField: 'digito',
                        displayField: 'descripcion',
                ...
                },
                {
                    config: {
                        name: 'fecha_de_pago',
                        fieldLabel: 'Fecha del documento de la transacción financiera',
                        allowBlank: true,
                        anchor: '90%',
                        gwidth: 100,
                        format: 'd/m/Y',
            ...
            fields: [
                ...
                {name: 'tipo_documento_respaldo', type: 'string'},
                {name: 'nro_documento_respaldo', type: 'string'},
                'monto_contrato',
                'numero_cuota',
            ...
            cambiarRevision: function (record) {
                ...
                Ext.Ajax.request({
                    ...
                    params: {
                        id_banca_compra_venta: d.id_banca_compra_venta,
                        revisado: d.revisado,
                ...
                if (existe_finalizado) {
                    Ext.Ajax.request({
                        ...
                        params: {
                            ...
                            'limit': 100000,
                            'acumulado': 'no',
                            'resolucion': this.cmbResolucion.getValue()
                        },
		...
		successGeneracion_txt: function (resp) {
            ...
            Clonar: function () {
                ...
                if (rec) {
                    ...
                    alert('Debe seleccionar un registro a clonar.');
                }
            },
            airbp: function () {
        ...
        , onButtonExportarExcelSIN: function () {
            var rec = this.cmbPeriodo.getValue();
            var tipo = this.tipoBan;
            //fRnk: validador adicionado para la exportación de datos al SIN, y otras mejoras al formulario
            var existe_finalizado = false;
            ...
            if (existe_finalizado) {
                Phx.CP.loadingShow();
                Ext.Ajax.request({
                    url: '../../sis_contabilidad/control/BancaCompraVenta/exportarXls',
                    params: {
                        'id_periodo': rec,
                        'tipo': tipo,
                        'start': 0,
