...
Phx.vista.Acumulado=Ext.extend(Phx.gridInterfaz,{
	...
	constructor:function(config){
		...
		if (config.tipo_monto == 'abierto'){
			...
			this.load({params:{start:0, limit:this.tam_pag,id_contrato:config.id_contrato,id_banca_compra_venta:config.id_banca_compra_venta,acumulado:'si',id_contrato_fk:config.id_contrato_fk}})
