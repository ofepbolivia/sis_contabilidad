    ...
    Phx.vista.RelacionContableTabla = {
        ...
        iniciarEventos : function() {
            ...
            this.Cmp.id_centro_costo.on('select', function (c,r,i) {
                ...
                this.partida_rubro = r.data.movimiento_tipo_pres;
                //if (this.filtro_partida == 'no') {
            ...
            this.Cmp.id_tipo_relacion_contable.on('select', function (c,r,i) { console.log('c',c,'r',r.data);
                ...
                if (r.data.tiene_partida == 'si') {
                    ...
                    Ext.apply(this.Cmp.id_partida.store.baseParams,{
                        ...
                        partida_rubro:this.partida_rubro/*r.data.partida_rubro*/});
