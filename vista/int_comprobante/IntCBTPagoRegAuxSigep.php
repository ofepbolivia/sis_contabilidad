...
/**
 *@package pXP
 *@file IntCBTPagoRegAuxSigep.php
 *@author   (franklin.espinoza)
 *@date     03-09-2020 10:22:05
 *@description Archivo con la interfaz de usuario Comprobante-Sigep
 *
 */
...
<script>
    Phx.vista.IntCBTPagoRegAuxSigep = {
        ...
        constructor: function(config) {
            ...
            me.addButtonCustom(config.idContenedor, 'sigep_verificado_pago', {
                grupo: [0],
                text : 'ENVIAR SIGEP',
                iconCls : 'bball_green',
                disabled : true,
            ...
            Phx.vista.IntCBTPagoRegAuxSigep.superclass.constructor.call(this,config);
            this.store.baseParams.tipo = 'pago';
        ...
        selectButton : function(grid, rowIndex, rec) {
            ...
            if(record.estado_reg == 'borrador'){
                this.getBoton('sigep_verificado_pago').setText('VERIFICAR SIGEP');
            }
        },

        deselectButton : function(grid, rowIndex, rec) {
            this.getBoton('sigep_verificado_pago').setText('ENVIAR SIGEP');
        },
        ...
        onSigepWizard:function(wizard,resp){
            ...
            if(rec.estado_reg == 'borrador') {
                if (rec.id_clase_comprobante == 5) {
                    ...
                    //if (rec.localidad == 'internacional'){
                        this.onSigepReguC(wizard, resp); console.log('onSigepReguC');
                    /*}else{
        ...
        successReg:function(resp){
            ...
            if(reg.datos.momento == 'REGULARIZACION'){
                var service_code = 'REGULARIZAC';
            }else{
                var service_code = 'CON_IMPUTACION_V';
            }
        ...
        onButtonEdit:function(){
            ...
            Phx.vista.IntCBTPagoRegAuxSigep.superclass.onButtonEdit.call(this);
            this.Cmp.id_clase_comprobante.store.baseParams.tipo='pago';
        ...
        onButtonNew:function(){
            this.swButton = 'NEW';
            Phx.vista.IntCBTPagoRegAuxSigep.superclass.onButtonNew.call(this);
            this.Cmp.id_clase_comprobante.store.baseParams.tipo='pago';
        ...
        preparaMenu : function(n) {
            var tb = Phx.vista.IntCBTPagoRegAuxSigep.superclass.preparaMenu.call(this);
            ...
            //
            this.getBoton('sigep_verificado_pago').enable();

            return tb;
        },
        liberaMenu : function() {
            var tb = Phx.vista.IntCBTPagoRegAuxSigep.superclass.liberaMenu.call(this);
            ...
            this.getBoton('sigep_verificado_pago').disable();
