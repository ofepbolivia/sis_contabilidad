...
/**
 * @package pXP
 * @file gen-IntComprobanteEXT.php
 * @author  Maylee Perez Pastor
 * @date 20-08-2019 00:28:30
...
<script>
    ...
    Phx.vista.IntComprobanteEXT = Ext.extend(Phx.gridInterfaz, {
        fheight: '90%',
        fwidth: '90%',
        nombreVista: 'IntComprobanteEXT',
        constructor: function (config) {
            this.maestro = config.maestro;
            this.initButtons = [this.cmbDepto, this.cmbGestion];

            //llama al constructor de la clase padre
            Phx.vista.IntComprobanteEXT.superclass.constructor.call(this, config);
        ...
        Atributos: [{
            ...
            },
            {
                config: {
                    ...
                    emptyText: 'c31',
                    renderer: function (value, p, record) {
                        return String.format('{0}', record.data['c31']);
        ...
        ActList: '../../sis_contabilidad/control/IntComprobante/listarIntComprobanteEXT',
