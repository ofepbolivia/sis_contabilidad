...
/**
 * @package pXP
 * @file gen-IntComprobanteRegionalesExt.php
...
<script>
    ...
    Phx.vista.IntComprobanteRegionalesExt = Ext.extend(Phx.gridInterfaz, {
        fheight: '90%',
        fwidth: '90%',
        ...
        constructor: function (config) {
            ...
            Phx.vista.IntComprobanteRegionalesExt.superclass.constructor.call(this, config);
        ...
        fields: [{
            ...
            'id_depto_libro', 'id_cuenta_bancaria','desc_cuenta_bancaria','desc_depto_lb'],
