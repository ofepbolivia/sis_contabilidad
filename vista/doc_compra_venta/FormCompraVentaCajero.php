...
/**
 * @package pXP
 * @file    FormCompraVentaCajero.php
 * @author  Maylee Perez Pastor
 * @date    13-11-2019
 * @description permites subir archivos a la tabla de documento_doc
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.FormCompraVentaCajero = Ext.extend(Phx.frmInterfaz, {
        ...
        constructorEtapa2: function (config) {
            ...
            Phx.vista.FormCompraVentaCajero.superclass.constructor.call(this, config);
        ...
        loadValoresIniciales: function () {
            ...
            Phx.vista.FormCompraVentaCajero.superclass.loadValoresIniciales.call(this);
                ...
                if (i > 0 && !this.editorDetail.isVisible()) {
                    ...
                    if (this.aux != 'Póliza de Importación - DUI') {
                        ...
                        if ((total_det.toFixed(2) * 1) == this.Cmp.importe_doc.getValue()) {
                            Phx.vista.FormCompraVentaCajero.superclass.onSubmit.call(this, o, undefined, true);
                        }
                        else {
