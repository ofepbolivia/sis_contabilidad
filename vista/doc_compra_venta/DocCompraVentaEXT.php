...
/**
 * @package pXP
 * @file gen-DocCompraVentaEXT.php
 * @author  MAylee Perez Pastor
 * @date 26-02-2020 15:57:09
 * @description Archivo con la interfaz de usuario que permite la ejecucion de todas las funcionalidades del sistema
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.DocCompraVentaEXT = Ext.extend(Phx.gridInterfaz, {
        fheight: '80%',
        fwidth: '70%',
        tabEnter: true,
        tipoDoc: 'venta',
        ...
        constructor: function (config) {
            ...
            this.Atributos = [
                ...
                },
                {
                    ...
                    type: 'TextField',
                    filters: {pfiltro: 'dcvext.c_emisor', type: 'string'},
                    id_grupo: 1,
                    grid: true,
                    form: false
                },
                ...
                },
                {
                    ...
                    type: 'TextField',
                    filters: {pfiltro: 'prov.num_proveedor', type: 'string'},
                    id_grupo: 0,
                    grid: false,
                    form: false
                },
                {
                    ...
                    type: 'TextField',
                    filters: {pfiltro: 'prov.condicion', type: 'string'},
                    id_grupo: 0,
                    grid: false,
                    form: false
                },
            ...
            Phx.vista.DocCompraVentaEXT.superclass.constructor.call(this, config);
        ...
        arrayDefaultColumHidden: ['codigo_noiata', 'estacion','nombre', 'estado_reg'],
        bdel: true,
        bsave: true,
        onButtonAct: function () {
            if (!this.validarFiltros()) {
                ...
                this.store.baseParams.id_periodo = this.cmbPeriodo.getValue();
                this.store.baseParams.id_depto = this.cmbDepto.getValue();
                Phx.vista.DocCompraVentaEXT.superclass.onButtonAct.call(this);
            }
        },
        ...
        abrirFormulario: function (tipo, record) {
            ...
            me.objSolForm = Phx.CP.loadWindows('../../../sis_contabilidad/vista/doc_compra_venta/FormCompraVentaEXT.php',
                me.formTitulo,
                {
                    modal: true,
                    width: '70%',
                    height: (me.regitrarDetalle == 'si') ? '100%' : '98%',
                }, {
                    data: {
                        objPadre: me,
                        tipoDoc: me.tipoDoc,
        ...
        preparaMenu: function (tb) {
            Phx.vista.DocCompraVentaEXT.superclass.preparaMenu.call(this, tb)
        ...
        liberaMenu: function (tb) {
            Phx.vista.DocCompraVentaEXT.superclass.liberaMenu.call(this, tb);
            if (this.regitrarDetalle == 'si') {
                this.getBoton('btnWizard').enable();
            }
            else {
