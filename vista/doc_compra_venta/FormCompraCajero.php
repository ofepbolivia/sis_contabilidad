...
?>
<script>
    Phx.vista.FormCompraCajero=Ext.extend(Phx.frmInterfaz, {
        ActSave: '../../sis_contabilidad/control/DocCompraVenta/insertarDocCompletoCajero',
        tam_pag: 10,
        tabEnter: true,
        codigoSistema: 'ADQ',
        ...
        constructorEtapa2: function (config) {
            ...
            Phx.vista.FormCompraCajero.superclass.constructor.call(this, config);
        ...
        loadValoresIniciales: function () {
            ...
            Phx.vista.FormCompraCajero.superclass.loadValoresIniciales.call(this);
                        ...
                        store: new Ext.data.JsonStore(
                            {
                                ...
                                fields: ['id_plantilla', 'nro_linea', 'desc_plantilla', 'tipo',
                                    ...
                                    'sw_nro_dui', 'sw_ic', 'tipo_excento', 'valor_excento', 'sw_qr',
                                    'sw_nit', 'plantilla_qr', 'sw_estacion', 'sw_punto_venta', 'sw_codigo_no_iata'],
                                remoteSort: true,
        ...
        iniciarEventos: function () {
            ...
            /*
             this.Cmp.estacion.on('change',function(fild, newValue, oldValue){
             this.Cmp.id_punto_venta.store.baseParams.lugar = newValue;
             this.Cmp.id_punto_venta.modificado = true;
             this.Cmp.id_agencia.store.baseParams.lugar = newValue;
             this.Cmp.id_agencia.modificado = true;
             },this);
            ...
            if (me.regitrarDetalle == 'si') {
                ...
                if (i > 0 && !this.editorDetail.isVisible()) {
                    ...
                    if ((total_det.toFixed(2) * 1) == this.Cmp.importe_doc.getValue()) {
                        Phx.vista.FormCompraCajero.superclass.onSubmit.call(this, o, undefined, true);
                    }
                    else {
