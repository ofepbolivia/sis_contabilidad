...
<script>
    Phx.vista.FormFiltroEstadoCuentaDetallado=Ext.extend(Phx.frmInterfaz,{
        constructor:function(config)
        {
            ...
            Phx.vista.FormFiltroEstadoCuentaDetallado.superclass.constructor.call(this,config);
            this.init();
            this.iniciarEventos();
        ...
        east: {
            url: '../../../sis_contabilidad/vista/int_transaccion/EstadoCuentaDetallado.php',
            title: undefined,
            width: '70%',
            cls: 'EstadoCuentaDetallado'
        },
        title: 'Filtro detallado',
        ...
        loadValoresIniciales: function(){
            Phx.vista.FormFiltroEstadoCuentaDetallado.superclass.loadValoresIniciales.call(this);
